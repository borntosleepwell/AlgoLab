  ...
  return (
    <div className="min-h-screen bg-[#050505] flex flex-col selection:bg-[#F2F2F2] selection:text-[#050505] text-[#F2F2F2]">
      ...
      <div className="page-enter flex-1 flex flex-col justify-center items-center px-4 md:px-8 py-12 relative overflow-hidden">
        ...
        >
          {/* Top structural info */}
          <div className="w-full flex justify-between items-center font-mono text-[10px] md:text-xs uppercase tracking-[0.3em] text-[#aaaaaa] border-b border-[#333333] pb-4 mb-8 md:mb-12">
            <span>// VISION_LAB</span>
            <span className="animate-pulse">STATUS: PENDING_DEPLOYMENT</span>
          </div>
          ...
          <div className="w-full border-t border-[#333333] mt-12 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="font-mono text-xs uppercase tracking-widest text-[#555555]">
              ERR_NOT_FOUND
            </div>
          </div>
        </motion.div>
