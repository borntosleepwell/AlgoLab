...
function FigmaLabCard({ title, desc, path, type }: { title: string; desc: string; path: string; type: 'ALGORITHMS' | 'AUTOMATA' | 'VISION' }) {
  ...
  return (
    <motion.div 
      ...
      className="w-[445px] h-[697px] bg-[#111111] border border-[#333333] rounded-[10px] flex flex-col cursor-pointer transition-all overflow-hidden"
    >
...
export function AboutSection() {
  ...
  return (
    <div className="relative w-full flex flex-col items-center overflow-hidden bg-black text-white">
      ...
      <div className="w-full pt-[150px] pb-[280px] px-8 border-b border-[#333333] flex flex-col items-center z-10 bg-[#050505]">
         <motion.div 
      ...
      <div className="w-full bg-black flex flex-col items-center z-10 px-8">
        <motion.div 
          ...
          className="relative w-full max-w-[1200px] h-[500px] bg-[#0A0A0A] border border-[#333333] z-20 mt-[-150px] flex flex-col group transition-all hover:border-[#555555] hover:shadow-[12px_12px_0px_0px_rgba(51,51,51,1)]"
        >
           {/* Top Structural Bar */}
      ...
      {/* 3. Lab Cards Area */}
      <div id="lab-section" className="relative w-full flex justify-center pt-[100px] pb-[150px] z-10 overflow-hidden bg-black">
        <motion.div 
          variants={{
            hidden: {},
          ...
          className="flex flex-row flex-wrap justify-center gap-[24px] px-8 z-10"
        >
           <FigmaLabCard 
